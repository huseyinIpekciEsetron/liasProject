...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = LED_DRV_SCL_Pin|LED_DRV_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(LED_DRV_SCL_GPIO_Port, LED_DRV_SCL_Pin);

    HAL_GPIO_DeInit(LED_DRV_SDA_GPIO_Port, LED_DRV_SDA_Pin);
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  */
    ...
    */
    ...
    HAL_NVIC_SetPriority(LTDC_ER_IRQn, 1, 0);
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOJ, GPIO_PIN_0|GPIO_PIN_4|GPIO_PIN_10|GPIO_PIN_15);

    HAL_GPIO_DeInit(GPIOK, GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5
                          |GPIO_PIN_6);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, ETH_SCLK_Pin|ETH_MISO_Pin|ETH_MOSI_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = RS422_UART1_TX_Pin|RS422_UART1_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, RS422_UART1_TX_Pin|RS422_UART1_RX_Pin);
...
static void HAL_FMC_MspInit(void){
  ...
  */
  ...
  HAL_NVIC_SetPriority(FMC_IRQn, 3, 0);
